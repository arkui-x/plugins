 ...
 * Module define
 */
static napi_module_with_js EditableTitleBarModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
    .nm_modname = "arkui.advanced.EditableTitleBar",
    .nm_priv = ((void*)0),
    .nm_get_abc_code = NAPI_arkui_advanced_EditableTitleBar_GetABCCode,
};
...
{
    napi_module_with_js_register(&EditableTitleBarModule);
}
