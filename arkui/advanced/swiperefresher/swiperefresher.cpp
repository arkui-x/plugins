 ...
 * Module define
 */
static napi_module_with_js SwiperefresherModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
    .nm_modname = "arkui.advanced.Swiperefresher",
    .nm_priv = ((void*)0),
    .nm_get_abc_code = NAPI_arkui_advanced_Swiperefresher_GetABCCode,
};
...
{
    napi_module_with_js_register(&SwiperefresherModule);
}