...
#ifndef INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_PHOTO_RESULT_SET_H
#define INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_PHOTO_RESULT_SET_H
...
class PhotoResultSet : public ResultSet {
public:
    EXPORT PhotoResultSet() {}
    EXPORT ~PhotoResultSet();
    EXPORT PhotoResultSet(JNIEnv* env, jobject object);
...
private:
    std::shared_ptr<Plugin::PhotoCursorJni> cursorObject_;
};
}
}

#endif // INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_PHOTO_RESULT_SET_H