...
#ifndef PLUGINS_PHOTO_ACCESS_HELPER_RESULT_SET_ALBUM_H
#define PLUGINS_PHOTO_ACCESS_HELPER_RESULT_SET_ALBUM_H
...
class ResultSetAlbum : public ResultSet {
public:
    EXPORT ResultSetAlbum() {}
    EXPORT ~ResultSetAlbum();
    EXPORT ResultSetAlbum(PHFetchResult *result);
...
private:
    photoCursorAlbum *photoCursorAlbum_;
    bool isClose_;
};
}
}

#endif // PLUGINS_PHOTO_ACCESS_HELPER_RESULT_SET_ALBUM_H