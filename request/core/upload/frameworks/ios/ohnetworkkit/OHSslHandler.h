...
typedef NS_ENUM(NSUInteger, OHSSLPinningMode) {
    OHSSLPinningModeNone,
    OHSSLPinningModePublicKey,
    OHSSLPinningModeCertificate,
};
...
@property (readonly, nonatomic, assign) OHSSLPinningMode SSLPinningMode;
