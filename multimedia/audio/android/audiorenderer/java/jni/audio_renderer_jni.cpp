...
std::map<long, std::shared_ptr<AudioRendererDeviceChangeCallback>> AudioRendererJni::deviceChangeObserver_;
...
int32_t AudioRendererJni::RegisterRendererDeviceChangeListener(
    long rendererPtr, const std::shared_ptr<AudioRendererDeviceChangeCallback>& callback)
{
