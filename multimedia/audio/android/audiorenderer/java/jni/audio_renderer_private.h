...
public:
    ...
    bool PauseTransitent(StateChangeCmdType cmdType = CMD_FROM_CLIENT) const override { return false; };
    ...
    int32_t RegisterOutputDeviceChangeWithInfoCallback(
        const std::shared_ptr<AudioRendererOutputDeviceChangeCallback> &callback) override { return ERR_NOT_SUPPORTED; }
    int32_t UnregisterOutputDeviceChangeWithInfoCallback() override { return ERR_NOT_SUPPORTED; }
