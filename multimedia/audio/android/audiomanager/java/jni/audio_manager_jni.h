...
public:
    ...
    static int32_t GetDevices(DeviceFlag deviceFlag, std::vector<sptr<AudioDeviceDescriptor>>& desc);
    ...
    static std::vector<std::unique_ptr<AudioRendererChangeInfo>> GetAudioRendererChangeInfo(jobject jRendererConf);
    static std::vector<std::unique_ptr<AudioCapturerChangeInfo>> GetAudioCapturerChangeInfo(jobject jCapturerConf);
