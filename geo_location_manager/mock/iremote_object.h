...
#ifndef PLUGINS_BLUETOOTH_COMMON_MOCK_I_REMOTE_OBJECT_H
#define PLUGINS_BLUETOOTH_COMMON_MOCK_I_REMOTE_OBJECT_H
...
protected:
    explicit IRemoteObject(std::u16string descriptor = u"");
    virtual ~IRemoteObject() = default;
};
} // namespace OHOS
#endif // PLUGINS_BLUETOOTH_COMMON_MOCK_I_REMOTE_OBJECT_H
