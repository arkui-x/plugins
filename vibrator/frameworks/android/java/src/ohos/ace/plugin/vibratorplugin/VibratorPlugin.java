...
public class VibratorPlugin {
    ...
    private static final int HAPTIC_CLOCK_TIMER_AMPLITUDE = 204;
    private static final int HAPTIC_EFFECT_SOFT_AMPLITUDE = 10;
    private static final int HAPTIC_EFFECT_HARD_AMPLITUDE = 80;
    private static final int HAPTIC_EFFECT_SHARP_AMPLITUDE = 50;
    private static final int HAPTIC_NOTICE_SUCCESS_AMPLITUDE = 204;
    private static final int HAPTIC_NOTICE_FAIL_OR_WARNING_AMPLITUDE = 255;
    private static final int HAPTIC_OTHER_AMPLITUDE = 0;
    private static final long HAPTIC_CLOCK_TIMER_DURATION = 300L;
    private static final long HAPTIC_EFFECT_SOFT_DURATION = 10L;
    private static final long HAPTIC_EFFECT_HARD_DURATION = 50L;
    private static final long HAPTIC_EFFECT_SHARP_DURATION = 20L;
    private static final long HAPTIC_NOTICE_SUCCESS_OR_FAIL_DURATION = 400L;
    private static final long HAPTIC_NOTICE_WARNING_DURATION = 500L;
    ...
    public static long getDuration(String effectId) {
        switch (effectId) {
            case "haptic.clock.timer":
                return HAPTIC_CLOCK_TIMER_DURATION;
            case "haptic.effect.soft":
                return HAPTIC_EFFECT_SOFT_DURATION;
            case "haptic.effect.hard":
                return HAPTIC_EFFECT_HARD_DURATION;
            case "haptic.effect.sharp":
                return HAPTIC_EFFECT_SHARP_DURATION;
            case "haptic.notice.success":
            case "haptic.notice.fail":
                return HAPTIC_NOTICE_SUCCESS_OR_FAIL_DURATION;
            case "haptic.notice.warning":
                return HAPTIC_NOTICE_WARNING_DURATION;
            default:
    ...
    public static int getAmplitude(String effectId) {
        switch (effectId) {
            case "haptic.clock.timer":
                return HAPTIC_CLOCK_TIMER_AMPLITUDE;
            case "haptic.effect.soft":
                return HAPTIC_EFFECT_SOFT_AMPLITUDE;
            case "haptic.effect.sharp":
                return HAPTIC_EFFECT_SHARP_AMPLITUDE;
            case "haptic.effect.hard":
                return HAPTIC_EFFECT_HARD_AMPLITUDE;
            case "haptic.notice.success":
                return HAPTIC_NOTICE_SUCCESS_AMPLITUDE;
            case "haptic.notice.fail":
            case "haptic.notice.warning":
                return HAPTIC_NOTICE_FAIL_OR_WARNING_AMPLITUDE;
            default:
