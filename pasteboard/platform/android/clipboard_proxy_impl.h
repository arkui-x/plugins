...
#ifndef PLUGINS_CLIPBBOARD_PROXY_IMPL_H
#define PLUGINS_CLIPBBOARD_PROXY_IMPL_H
...
public:
    ...
    ~ClipboardProxyImpl() override = default;
...
private:
    ...
    std::set<sptr<PasteboardObserverStub>> observerSet_;
};
} // namespace Plugin
} // namespace OHOS
