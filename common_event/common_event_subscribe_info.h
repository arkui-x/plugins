...
#ifndef PLUGINS_COMMONEVENT_COMMON_EVENT_SUBSCRIBE_INFO_H
#define PLUGINS_COMMONEVENT_COMMON_EVENT_SUBSCRIBE_INFO_H
#include <string>
#include <vector>
...
#endif  // PLUGINS_COMMONEVENT_COMMON_EVENT_SUBSCRIBE_INFO_H