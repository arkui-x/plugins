...
#ifndef PLUGINS_COMMONEVENT_COMMON_EVENT_SUBSCRIBER_H
#define PLUGINS_COMMONEVENT_COMMON_EVENT_SUBSCRIBER_H
...
#endif  // PLUGINS_COMMONEVENT_COMMON_EVENT_SUBSCRIBER_H