 ...
 * Module define
 */
static napi_module_with_js DecimalModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
    .nm_modname = "arkts.math.Decimal",
    .nm_priv = ((void*)0),
    .nm_get_abc_code = NAPI_arkts_math_Decimal_GetABCCode,
    .nm_get_js_code = NAPI_arkts_math_Decimal_GetMJSCode,
};
...
{
    napi_module_with_js_register(&DecimalModule);
}
