...
#ifndef PLUGINS_COMMON_EVENT_MANAGER_ANDROID_JAVA_JNI_COMMON_EVENT_IMPL_H
#define PLUGINS_COMMON_EVENT_MANAGER_ANDROID_JAVA_JNI_COMMON_EVENT_IMPL_H
...
#endif // PLUGINS_COMMON_EVENT_MANAGER_ANDROID_JAVA_JNI_COMMON_EVENT_IMPL_H