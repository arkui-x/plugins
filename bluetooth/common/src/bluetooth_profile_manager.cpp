...
{
    HILOGI("enter BluetoothProfileManager::GetInstance");
...
{
    HILOGI("enter BluetoothProfileManager::RegisterFunc");
    GetValidId();
    ProfileIdProperty value;
...
{
    HILOGI("enter BluetoothProfileManager::RegisterFunc ProfileFunctions");
    GetValidId();
    ProfileIdProperty value;
    ProfileIdProperty idProperties;
    idProperties.objectName = objectName;
