...
#ifndef PLUGINS_BLUETOOTH_COMMON_MOCK_IPC_OBJECT_PROXY_H
#define PLUGINS_BLUETOOTH_COMMON_MOCK_IPC_OBJECT_PROXY_H
...
public:
    explicit IPCObjectProxy(
        int handle, std::u16string descriptor = std::u16string(), int proto = IRemoteObject::IF_PROT_DEFAULT);
    ~IPCObjectProxy();
...
#endif // PLUGINS_BLUETOOTH_COMMON_MOCK_IPC_OBJECT_PROXY_H
