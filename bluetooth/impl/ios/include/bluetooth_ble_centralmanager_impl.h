...
#ifndef OHOS_BLUETOOTH_STANDARD_BLE_CENTRAL_MANAGER_IMPL_H
#define OHOS_BLUETOOTH_STANDARD_BLE_CENTRAL_MANAGER_IMPL_H
...
private:
    ...
    std::map<int32_t, std::vector<BluetoothBleScanFilter>> scanFilterMap_;
    int getCallBackScannerId();
};
} // namespace Bluetooth
} // namespace OHOS
#endif // OHOS_BLUETOOTH_STANDARD_BLE_CENTRAL_MANAGER_IMPL_H