...
{
    HILOGI("BluetoothGattClientImpl RegisterApplication enter.");
...
{
    HILOGI("BluetoothGattClientImpl DeregisterApplication enter.");
...
{
    HILOGI("BluetoothGattClientImpl Connect enter.");
    int result = BT_NO_ERROR;
...
{
    HILOGI("BluetoothGattClientImpl DiscoveryServices enter.");
    auto gattClientData = BluetoothGattClientImpl::GetGattClientData(appId);
...
{
    HILOGI("BluetoothGattClientImpl ReadCharacteristic enter.");
    auto gattClientData = BluetoothGattClientImpl::GetGattClientData(appId);
...
{
    HILOGI("BluetoothGattClientImpl WriteCharacteristic enter.");
    int32_t result = BT_NO_ERROR;
    auto gattClientData = BluetoothGattClientImpl::GetGattClientData(appId);
    if (gattClientData) {
        BluetoothGattCharacteristic gattCharacteristic = BluetoothGattCharacteristic(*characteristic);
...
{
    HILOGI("BluetoothGattClientImpl ReadDescriptor enter.");
    int32_t result = BT_NO_ERROR;
    auto gattClientData = BluetoothGattClientImpl::GetGattClientData(appId);
    if (gattClientData) {
...
{
    HILOGI("BluetoothGattClientImpl WriteDescriptor enter.");
    int32_t result = BT_NO_ERROR;
    auto gattClientData = BluetoothGattClientImpl::GetGattClientData(appId);
    if (gattClientData) {
        BluetoothGattDescriptor gattDescriptor = BluetoothGattDescriptor(*descriptor);
...
{
    HILOGI("BluetoothGattClientImpl RequestExchangeMtu enter.");
...
{
    HILOGI("BluetoothGattClientImpl GetServices enter.");
    auto gattClientData = BluetoothGattClientImpl::GetGattClientData(appId);
...
{
    HILOGI("BluetoothGattClientImpl GetServiceUuidByHandle enter.");
...
{
    HILOGI("BluetoothGattClientImpl GetCharacterUuidByHandle enter.");
...
{
    HILOGI("BluetoothGattClientImpl GetDescriptorUuidByHandle enter.");
