...
#ifndef PLUGINS_INTL_PLUGIN_ANDROID_JAVA_JNI_INTL_PLUGIN_IMPL_H
#define PLUGINS_INTL_PLUGIN_ANDROID_JAVA_JNI_INTL_PLUGIN_IMPL_H
...
#endif // PLUGINS_INTL_PLUGIN_ANDROID_JAVA_JNI_INTL_PLUGIN_IMPL_H
